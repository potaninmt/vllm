...
class Qwen2BiasModel(nn.Module):
...
class Qwen2BiasForCausalLM(nn.Module, SupportsLoRA, SupportsPP):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        self.model = Qwen2BiasModel(vllm_config=vllm_config,
